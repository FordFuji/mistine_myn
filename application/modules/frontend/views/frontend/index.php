        ...
        <div class="row wow fadeInDown">
            <div class="col-12 nopan">
                <div class="flexslider">
                    <ul class="slides">
<?php
if(!empty($bannerSlideCtrl)) {
    foreach($bannerSlideCtrl as $r) {
?>                        
                        <li>
                            <div class="wrap_slidecaption">
                                <?php echo get2Lang($this->session->userdata('lang'), $r->banner_slide_text_lang1, $r->banner_slide_text_lang2);?>
                            </div>
                            <img src="<?php echo base_url('uploads/banner_slide/'.$r->banner_slide_image);?>" class="img-fluid" style="width: 100%;" />
                        </li>
<?php
    }
}
                        ...
                        <li>
                            <div class="wrap_slidecaption">
                                ...
                                <div class="slidecaption slideright">
                                    ...
                                    <p><a href="<?php echo site_frontend('new_readmore.php');?>">Browse Products <i class="fa fa-angle-right" aria-hidden="true"></i></a></p>
                                </div>
                            </div>
                            <img src="<?php echo base_frontend('images/img_slidehome_1.jpg');?>" class="img-fluid" style="width: 100%;" />
                        </li>
                        <li>
                            <div class="wrap_slidecaption">
                                <div class="slidecaption slideleft">
...
?>
                        <div class="col-6 col-md-6 col-lg-3 col-xl-3 pad_r_brands">
                            <div class="hovereffect img_brandshome">
                                <a href="<?php echo site_url('frontend/path/products/category1/'.$r->category1_id);?>"><img src="<?php echo base_url('uploads/category1/'.$r->category1_image);?>" class="img-fluid"></a>
                            </div>
                        </div>
<?php
    }
...
?>
                        <div class="col-6 col-md-6 col-lg-3 col-xl-3 pad_l_brands">
                            <div class="hovereffect img_brandshome">
                                <a href="<?php echo site_frontend('products.php');?>"><img src="<?php echo base_frontend('images/brands_02.png');?>" class="img-fluid"></a>
                            </div>
                        </div>
                        <div class="col-6 col-md-6 col-lg-3 col-xl-3 pad_r_brands">
                            <div class="hovereffect img_brandshome">
                                <a href="<?php echo site_frontend('products.php');?>"><img src="<?php echo base_frontend('images/brands_03.png');?>" class="img-fluid"></a>
                            </div>
                        </div>
                        <div class="col-6 col-md-6 col-lg-3 col-xl-3 pad_l_brands">
                            <div class="hovereffect img_brandshome">
                                <a href="<?php echo site_frontend('products.php');?>"><img src="<?php echo base_frontend('images/brands_01.png');?>" class="img-fluid"></a>
                            </div>
                        </div>
*/
?>                        
                    </div>
                    <!-- <div class="view_category"><a href="<?php echo site_frontend('products.php');?>">View all category</a></div> -->
                </div>
...
<?php
if(!empty($productNewCtrl)) {
    foreach($productNewCtrl as $r) {
...
?>
                                    ...
                                    <h4><?php echo get2Lang($this->session->userdata('lang'), $r->product_name_lang1, $r->product_name_lang1);?></h4>
                                    <div class="row">
                                        <div class="col-6">
    <h5><?php if($r->product_before_discount_price_type1 != '0') { ?><span>Ks <?php echo number_format($r->product_before_discount_price_type1, 0, '.', ',');?></span><br><?php } ?>Ks <?php echo number_format($r->product_price1, 0, '.', ',');?></h5>
                                        </div>
                                        <div class="col-6">
                                            <h6><?php if(!empty($this->model_frontend->getAvgStar($r->product_id))) echo getStar($this->model_frontend->getAvgStar($r->product_id));?></span></h6>
                                        </div>
                                    </div>
...
<?php 
if(!empty($topRanking)) {
    foreach($topRanking as $r) {
?>
        <div class="col-6 col-md-4 col-lg-3 col-xl-3 pad_r_brands">
            <div class="img_products">
                <div class="img_product">
                    <a href="<?php echo site_url('frontend/path/product_inside/'.$r->product_id);?>">
                        <img src="<?php echo base_url('uploads/product/'.$r->product_image);?>" alt="Avatar" class="img-fluid">
                        <div class="overlay_product">
                            <a href="javascript:wishlist('<?php echo $r->product_id;?>');" class="icon_search aWishlist_<?php echo $r->product_id;?>">
<?php
        $select_wishlist = $this->model_frontend->getWishlistColor($r->product_id);
    ...
    <h5><?php if($r->product_before_discount_price_type1 != '0') { ?><span>Ks <?php echo number_format($r->product_before_discount_price_type1, 0, '.', ',');?></span><br><?php } ?> Ks <?php echo number_format($r->product_price1, 0, '.', ',');?></h5>
                    ...
                    <div class="col-6">
                        <h6><?php if(!empty($this->model_frontend->getAvgStar($r->product_id))) echo getStar($this->model_frontend->getAvgStar($r->product_id));?></h6>
                            <p>Sold <?php echo $r->sum_order_qty;?></p>                            
                    </div>
                </div>
            </div>
        </div>
...
?>
    ...
    <div class="row">
<?php
if($this->session->userdata('member_id') != '' and !empty($categoryVoucherCtrl)) {
?>
        <div class="col-12 pad_vouchers">
            <a href="<?php echo site_url('frontend/path/vouchers');?>"><img src="<?php echo base_url('uploads/category_voucher/'.$categoryVoucherCtrl->category_voucher_image);?>" class="img-fluid"></a>
        </div>
<?php
}
?>
        <div class="col-12 pad_flexslider_product wow fadeInDown">
            <div id="flexslider_product" class="flexslider">
                    <ul class="slides">
<?php
if(!empty($promotionBannerCtrl)) {
    foreach($promotionBannerCtrl as $r) {

?>
                        <li>
                            <img src="<?php echo base_url('uploads/promotion_banner/'.$r->promotion_banner_image);?>" class="img-fluid">
                        </li>
<?php
    }
}
/*
                        <li>
                            <img src="<?php echo base_frontend('images/imgslide_banner_1.jpg');?>" class="img-fluid">
                        </li>
                        <li>
                            <img src="<?php echo base_frontend('images/imgslide_banner_1.jpg');?>" class="img-fluid">
                        </li>
...
<?php
if(!empty($productSuggestCtrl)) {
    foreach($productSuggestCtrl as $r) {
?>        
                            <div class="item">
                                <div class="box_products">
                                    <div class="img_products">
