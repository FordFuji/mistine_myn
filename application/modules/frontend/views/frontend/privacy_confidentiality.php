...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="container">
                <div class="row">
                    <div class="col-12 information_contact wow fadeInDown" style="padding-top: 15px; padding-bottom: 50px;">
                        <span style="font-size: 12px;">
<h2>Privacy and Confidentiality</h2>
<p>
Welcome to the mistinemyanmar.com.mm website (the "Site") operated by E-Cart Internet Services. We respect your privacy and want to protect your personal information. To learn more, please read this Privacy Policy.
</p>
<p>
