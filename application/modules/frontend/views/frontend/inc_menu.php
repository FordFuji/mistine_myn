...
?>
                <div class="col-lg-2">
                    <div class="search-container">
                        <!-- <img src="<?php echo base_frontend('images/search.png');?>" data-toggle="modal" data-target="#myModal4" class="img-fluid"> -->
                        <a href="<?php echo site_url('frontend/path/cart_shopping');?>"><img src="<?php echo base_frontend('images/shopping.png');?>" class="img-fluid"></a> <div class="cart_no"><?php echo $i;?></div> <img src="<?php echo base_frontend('images/menu.png');?>" data-toggle="modal" data-target="#myModal3" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
