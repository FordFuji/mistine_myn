                                ...
                                <div class="sorted_by">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-7">
                                            <ul>
                                                <li <?php if(empty($_GET['type'])) echo 'class="active"'; elseif($_GET['type'] == '' or $_GET['type'] == 'new') echo 'class="active"';?>>
                                                    <a href="<?php echo site_url('frontend/path/products/'.$type.'/'.$category3_id.'?type=new');?>">New</a>
                                                </li>
                                                <li <?php if(empty($_GET['type'])) echo 'class="active"'; elseif($_GET['type'] == '' or $_GET['type'] == 'bestsellers') echo 'class="active"';?>>
                                                    <a href="<?php echo site_url('frontend/path/products/'.$type.'/'.$category3_id.'?type=bestsellers');?>">Best sellers</a>
                                                </li>
                                                <li>
                                                <select class="form-control" onchange="changePrice(this.value);">
                                                    <option value="">Price</option>
                                                    <option value="price_z_a">Price high to low</option>
                                                    <option value="price_a_z">Price low to high</option>
                                                </select>
                                                </li>
                                            </ul>
...
?>
                                ...
                                <!-- <div class="md_sorted_by sorted_by">
                                    <div class="row">
                                        ...
                                        <div class="col-1 pad_sorted_by <?php if(empty($_GET['type'])) echo 'active_product'; elseif(!empty($_GET['type']) and $_GET['type'] != '') echo 'active_product'; elseif($_GET['type'] == 'bestsellers') echo 'none_product'; elseif($_GET['type'] == 'new') echo 'active_product"';?>">
                                            <h5><a href="<?php echo site_url('frontend/path/products/'.$type.'/'.$category3_id.'?type=new');?>">NEW</a></h5>
                                        </div>
                                        <div class="col-2 pad_sorted_by <?php if(empty($_GET['type'])) echo 'active_product'; elseif(!empty($_GET['type']) and $_GET['type'] != '') echo 'active_product'; elseif($_GET['type'] == 'bestsellers') echo 'active_product'; elseif($_GET['type'] == 'new') echo 'none_product"';?>">
                                        ...
                                        <div class="col-3 pad_sorted_by">
                                            <div class="dropdown open"> 
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-form-menu" role="menu">
                                                    <li><a href="<?php echo site_url('frontend/path/products/'.$type.'/'.$category3_id.'?type='.$this->input->get('type').'&sort=price_z_a');?>">Price high to low</a></li>
                                                    <li><a href="<?php echo site_url('frontend/path/products/'.$type.'/'.$category3_id.'?type='.$this->input->get('type').'&sort=price_a_z');?>">Price low to high</a></li>
                                                </ul>
                                            </div>
...
?>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
    <h5><?php if($r->product_before_discount_price_type1 != '0') { echo  '<span>KS '.number_format($r->product_before_discount_price_type1, 0, '.', ',');?></span><br><?php } ?> Ks <?php echo number_format($r->product_price1, 0, '.', ',');?></h5>
                                                </div>
                                                <div class="col-6">
...
?>
        ...
        function changePrice(order_by) {
            window.location.href = "<?php echo site_url('frontend/path/products/'.$type.'/'.$category3_id.'?type='.$this->input->get('type').'&sort=');?>" + order_by;
        }
        </script>
    </div>
</body>
