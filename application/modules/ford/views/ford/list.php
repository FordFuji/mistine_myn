			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('ford/backend/form');?>';" style="margin-bottom: 10px;">Add</button>
								...
								<table id="data-table" class="table table-striped table-bordered">
						            <thead>
						                <tr>
						                    ...
						                    <th>ford_image</th>
						                    <th class="select-filter">ford_name</th>
						                    <th>ford_ckeditor</th>
						                    <th>Action</th>
						                </tr>
						            </thead>
	...
	<script>
		$(document).ready(function() {
    		...
    		var table = $('#data-table').DataTable({ 
		        ...
		        "ajax": {
		            "url": "<?php echo site_url('ford/backend/server_processing');?>",
		            "type": "POST"
		        },
