...
class Model_cancel_datatable extends CI_Model { 
 	
 	private $column_order = array('order_no', 'member_first_name', 'member_phone', 'member_email', null, 'order_name', 'order_name', 'order_qty'); //set column field database for datatable cancelable
    ...
    private $cancel = array('cancel_id' => 'desc'); // default cancel
