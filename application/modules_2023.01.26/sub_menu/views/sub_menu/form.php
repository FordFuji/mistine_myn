		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Managed Form <small><?php if(!empty($title)) echo str_replace("_", " ", $title);?></small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title"><?php if(!empty($title)) echo str_replace("_", " ", $title);?></h4>
                        </div>
                        <div class="panel-body">
<?php
if(!empty($id)) {
?>
							<form class="form-horizontal" id="form_menu" action="<?php echo site_url('sub_menu/backend/save_update/'.$id);?>" method="post" enctype="multipart/form-data">
<?php
} else {
?>
							<form class="form-horizontal" id="form_menu" action="<?php echo site_url('sub_menu/backend/save_update');?>" method="post" enctype="multipart/form-data">
<?php
}
...
?>
											<option value="<?php echo $r->menu_id;?>" <?php if(!empty($row)) { if($row->menu_id == $r->menu_id) echo ' selected'; }?>><?php echo $r->menu_name;?></option>
<?php
	}
}
?>                                 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Name" name="sub_menu_name" id="sub_menu_name" value="<?php if(!empty($row)) echo $row->sub_menu_name;?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Path</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Path" name="sub_menu_controller" id="sub_menu_controller" value="<?php if(!empty($row)) echo $row->sub_menu_controller;?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Sort</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Sort" name="sub_menu_sort" id="sub_menu_sort" value="<?php if(!empty($row)) echo $row->sub_menu_sort;?>" />
                                    </div>
                                </div>
                                <!-- <div class="form-group">
...
?>                                 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="sub_menu_enable" value="1" <?php if(!empty($row)) { if($row->sub_menu_enable == '1') echo ' checked'; }?> />
                                                Enable
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="sub_menu_enable" value="0" <?php if(!empty($row)) { if($row->sub_menu_enable == '0') echo ' checked'; }?> />
                                                Disable
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" placeholder="Link" name="sub_menu_link" id="sub_menu_link" value="<?php if(!empty($row)) echo $row->sub_menu_link;?>" />
                                    </div>
                                </div>
                                <div class="form-group">
