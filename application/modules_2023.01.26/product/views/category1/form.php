...
?>
							...
							<div class="form-group">
					            ...
					            <div class="col-md-9">
                       				<input type="file" name="category1_image" id="category1_image" class="form-control"> Recommend 328 x 321 px
<?php
if(!empty($row)) {
...
?>
							...
							<div class="form-group">
					            <label class="col-md-3 control-label">Category 1 (En)</label>
					            <div class="col-md-9">
                       				<input type="text" name="category1_name_lang1" id="category1_name_lang1" class="form-control" value="<?php if(!empty($row)) echo $row->category1_name_lang1;?>">
					            </div>
					        </div>
					        <div class="form-group">
					            <label class="col-md-3 control-label">Category 1 (Myan)</label>
					            <div class="col-md-9">
                       				<input type="text" name="category1_name_lang2" id="category1_name_lang2" class="form-control" value="<?php if(!empty($row)) echo $row->category1_name_lang2;?>">
					            </div>
					        </div>
					        <div class="form-group">
