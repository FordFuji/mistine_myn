			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('product/backend/category3_form');?>';" style="margin-bottom: 10px;">Add</button>
                            <div class="table-responsive">
								<table id="data-table" class="table table-striped table-bordered">
						            <thead>
						                <tr>
						                	<th class="select-filter">ID</th>
						                	<th>Category Level 1 (En) / (Myan)</th>
						                    <th>Category Level 2 (En) / (Myan)</th>
						                    <th>Category Level 3 (En)</th>
						                    <th>Category Level 3 (Myan)</th>
						                    <th>Weight</th>
						                    <th>Color</th>
						                    <th>Collection</th>
						                    <th>Action</th>
	...
	<script>
		$(document).ready(function() {
    		...
    		var table = $('#data-table').DataTable({ 
		        ...
		        "ajax": {
		            "url": "<?php echo site_url('product/backend/category3_server_processing');?>",
		            "type": "POST"
		        },
