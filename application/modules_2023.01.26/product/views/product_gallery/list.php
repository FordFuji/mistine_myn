			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<!-- <button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('product/backend/product_gallery_form');?>';" style="margin-bottom: 10px;">Add</button> -->
								...
								<table id="data-table" class="table table-striped table-bordered">
						            <thead>
						                <tr>
						                	...
						                	<th>Product (En) / Product (Myan)</th>
						                	<th>Weight (En) / Weight (Myan)</th>
						                	<th>Color (En) / Color (Myan)</th>
						                	<th>Collection (En) / Collection (Myan)</th>
						                	<th>Product Code</th>
						                	<th>Product Before Discount Price (Myan)</th>
						                	<th>Product Price (Myan)</th>
						                	<th>Stock Amount</th>
						                    <th>Gallery</th>
						                    <th>Action</th>
						                </tr>
	...
	<script>
		$(document).ready(function() {
    		...
    		var table = $('#data-table').DataTable({ 
		        ...
		        "ajax": {
		            "url": "<?php echo site_url('product/backend/product_gallery_server_processing');?>",
		            "type": "POST"
		        },
