			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('voucher/backend/category_voucher_form');?>';" style="margin-bottom: 10px;">Add</button>
	...
	<script>
		$(document).ready(function() {
    		...
    		var table = $('#data-table').DataTable({ 
		        ...
		        "ajax": {
		            "url": "<?php echo site_url('voucher/backend/category_voucher_server_processing');?>",
		            "type": "POST"
		        },
		...
		function setActiveCategoryVoucher(category_voucher_id) {
			$.post('<?php echo site_url("voucher/backend/ajaxSetActive");?>', { category_voucher_id: category_voucher_id }, function(data) {
				alert('Set Active Success');
			});
		}
	</script>
</body>
