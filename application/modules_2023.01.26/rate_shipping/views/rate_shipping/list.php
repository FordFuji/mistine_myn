			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('rate_shipping/backend/form');?>';" style="margin-bottom: 10px;">Add</button>
								...
								<table id="data-table" class="table table-striped table-bordered">
						            <thead>
						                <tr>
						                    ...
						                    <th>Region/State</th>
						                    <th>Township</th>
						                    <th>ค่าขนส่ง น้ำหนักขั้นต่ำ (KS)</th>
											<th>จำนวนน้ำหนักขั้นต่ำ (KG)</th>
											<th>เพิ่มทุกกี่กิโล (KG)</th>
											<th>ค่าขนส่งเพิ่มขึ้นทีละ (KS)</th>
											<th>ระยะเวลาการขนส่ง(วัน)</th>
						                    <th>Action</th>
						                </tr>
						            </thead>
						            <tbody>
	...
	<script>
		$(document).ready(function() {
    		...
    		var table = $('#data-table').DataTable({ 
		        ...
		        "ajax": {
		            "url": "<?php echo site_url('rate_shipping/backend/server_processing');?>",
		            "type": "POST"
		        },
