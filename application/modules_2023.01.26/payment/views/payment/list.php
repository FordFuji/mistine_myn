			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='<?php echo site_url('payment/backend/form');?>';" style="margin-bottom: 10px;">Add</button>
								...
								<table id="data-table" class="table table-striped table-bordered">
						            <thead>
						                <tr>
						                    ...
						                    <th>payment_image</th>
						                    <th class="select-filter">payment_name</th>
						                    <th>payment_ckeditor</th>
						                    <th>Action</th>
						                </tr>
						            </thead>
						            <tfoot>
	...
	<script>
		$(document).ready(function() {
    		...
    		var table = $('#data-table').DataTable({ 
		        ...
		        "ajax": {
		            "url": "<?php echo site_url('payment/backend/server_processing');?>",
		            "type": "POST"
		        },
