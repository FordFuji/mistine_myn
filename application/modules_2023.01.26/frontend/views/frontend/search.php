                    ...
                    <div class="col-12 wow fadeInDown">
                        <!-- <div class="md_sorted_by_block sorted_by">
                            <div class="row">
                                ...
                                <div class="col-6 col-md-1 <?php if($this->input->get('type') == 'new') echo 'pad_l_sorted'; else 'pad_sorted_by pad_r_sorted';?>">
                                    <h5><a href="">NEW</a></h5>
                                </div>
                                <div class="col-6 col-md-2 <?php if($this->input->get('type') == 'bestsellers') echo 'pad_sorted_by pad_r_sorted'; else 'pad_l_sorted';?>">
                                ...
                                <div class="col-md-3 pad_sorted_l">
                                    <p>Showing 1-16 of 150 results</p>
                                </div>
                            </div>
                        </div> -->
                                    ...
                                    <!-- <div class="row">
                                        ...
                                        <div class="col-3 pad_sorted_by">
                                            <div class="dropdown open"> 
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-form-menu" role="menu">
                                                    <li><a href="<?php echo site_url('frontend/path/products/'.$type.'/'.$category3_id.'?sort=price_z_a');?>">Price high to low</a></li>
                                                    <li><a href="<?php echo site_url('frontend/path/products/'.$type.'/'.$category3_id.'?sort=price_a_z');?>">Price low to high</a></li>
                                                </ul>
                                            </div>
...
?>
                                        ...
                                        <div class="col-3 pad_sorted_l">
                                            <p>Showing 
                                            <?php if($this->input->get('per_page') == 1 or $this->input->get('per_page') == '') echo 1; else echo ($this->input->get('per_page') * $per_page) - $per_page + 1;?>
                                            -
                                            <?php if($this->input->get('per_page') == 1 or $this->input->get('per_page') == '') echo $i; else echo ($this->input->get('per_page') * $per_page) - $per_page + $i + 1;?> of <?php echo count($this->model_frontend->getProductCategory3ResultAll($category3_id));?> results</p>
                                        </div>
                                    </div> 
*/
?>
...
?>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <h5><span>Ks <?php echo number_format($r->product_before_discount_price_type1, 0, '.', ',');?></span> Ks <?php echo number_format($r->product_price1, 0, '.', ',');?></h5>
                                                </div>
                                                <div class="col-6">
