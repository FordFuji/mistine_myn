...
<h4><?php if(!empty($row) and $row->product_before_discount_price_type1 != '0') { ?><span class="product_before_discount_price_type1"><?php echo number_format($row->product_before_discount_price_type1, 0, '.', ',');?> KS</span><?php } ?> <span class="product_price1"><?php if(!empty($row)) echo number_format($row->product_price1, 0, '.', ',');?> KS</span></h4>
...
?>
                                            <img src="<?php echo base_frontend('images/icon_shopping.png');?>" class="img-fluid">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <h5><span><?php echo number_format($r->product_before_discount_price_type1, 2, '.', ',');?> KS</span> <?php echo number_format($r->product_price1, 2, '.', ',');?> KS</h5>
                                                    </div>
                                                    <div class="col-6">
