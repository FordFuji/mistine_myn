...
?>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
    <h5><?php if($r->product_before_discount_price_type1 != '0') { ?><span>Ks <?php echo number_format($r->product_before_discount_price_type1, 0, '.', ',');?></span><?php } ?>Ks <?php echo number_format($r->product_price1, 0, '.', ',');?></h5>
                                        </div>
                                        <div class="col-6">
