                    ...
                    <div class="row">
                            ...
                            <div class="stepwizard">
                                <div class="stepwizard-row">
                                    <div class="stepwizard-step">
                                        <button type="button" class="btn btn-link"><img src="images/icom-step1.png"></button>
                                        <p><span class="shipping">Shipping Address</span></p>
                                    </div>
                                    <div class="hr-stepw"></div>
                                    <div class="stepwizard-step">
                                        <button type="button" class="btn btn-circle" style="border: 2px solid #ec008c"><img src="images/icom-step2-1.png"></button>
                                        <p>Payment And Shipping</p>
                                    </div>
                                    <div class="stepwizard-step">
                                        <button type="button" class="btn btn-circle"><img src="images/icom-step3.png"></button>
                                        <p>Product Summary</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-4 col-xl-4 bg_boxsummary mobile_bg_boxsummary">
                            ...
                            <div class="text_order">
                                ...
                                <div class="buttom_register"><a href="productsummary.php">next</a></div>
                            </div>
                        </div>
                    </div>
                </div>
